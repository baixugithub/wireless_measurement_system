...
const u8 RX_ADDRESS[RX_ADR_WIDTH]={0x34,0x43,0x10,0x10,0x02}; //发送地址

//const u8 TX_ADDRESS1[TX_ADR_WIDTH]={0x34,0x43,0x10,0x10,0x06}; //发送地址20140526改
const u8 RX_ADDRESS1[RX_ADR_WIDTH]={0x34,0x43,0x10,0x10,0x06}; //发送地址							    
...
void RX_Mode1(void)
	{
	Clr_NRF24L01_CE;	  
	NRF24L01_Write_Buf(NRF24L01_WRITE_REG+RX_ADDR_P0,(u8*)RX_ADDRESS1,RX_ADR_WIDTH);//写RX节点地址
...
////	{														 
////	Clr_NRF24L01_CE;	    
////	NRF24L01_Write_Buf(NRF24L01_WRITE_REG+TX_ADDR,(u8*)TX_ADDRESS1,TX_ADR_WIDTH);//写TX节点地址 
////	NRF24L01_Write_Buf(NRF24L01_WRITE_REG+RX_ADDR_P0,(u8*)RX_ADDRESS,RX_ADR_WIDTH); //设置TX节点地址,主要为了使能ACK	  
////	
////	NRF24L01_Write_Reg(NRF24L01_WRITE_REG+EN_AA,0x01);     //使能通道0的自动应答    
////	NRF24L01_Write_Reg(NRF24L01_WRITE_REG+EN_RXADDR,0x01); //使能通道0的接收地址  
